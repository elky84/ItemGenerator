...
excel2dotnet -d "excel" -n ItemGenerator.Types -u "using EnumExtend;" -e -l
if ERRORLEVEL 1 GOTO END

excel2dotnet -d "excel" -n ItemGenerator -u "using EnumExtend;" "using ItemGenerator.Types;" -l
if ERRORLEVEL 1 GOTO END
